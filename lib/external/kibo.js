...
Kibo.prototype.registerMe = function () {
...
Kibo.prototype.unregisterMe = function () {
    if (this.isRegistered) {
        Kibo.unregisterEvent(this.element, 'keydown', this.downHandler);
        Kibo.unregisterEvent(this.element, 'keyup', this.upHandler);
