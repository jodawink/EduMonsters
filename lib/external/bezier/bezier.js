(function (module, undefined) {
    ...
    var PolyBezier = module.PolyBezier;
...
//    }
    ...
    Bezier.prototype = {
        ...
        map: function (u) {
            var targetLength = u * this.arcLengths[this.precision];
            var low = 0, high = this.precision, index = 0;
            while (low < high) {
            ...
            if (lengthBefore === targetLength) {
                ...
                return (index + (targetLength - lengthBefore) / (this.arcLengths[index + 1] - lengthBefore)) / this.precision;
            }
        },
