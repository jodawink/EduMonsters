...
class ProfileController extends AdminController {
    ...
    public function main() {
        ...
        $uploadify->set_thumbnail('thumb',200,200);
    ...
    private function update_profile() {
        ...
        $existing_user = User::find_by_email($this->get_post('email'));
        
        if($existing_user && $existing_user->user_id !== Membership::instance()->user->user_id){
            $this->set_error("The Email is already in use by an other user");    
            return;
        }
