...
class AuthenticationController extends Controller {
    ...
    public function login() {
        ...
        if (isset($_POST) and $_POST) {
            ...
            if(!$user){
                $user = User::find_by_email($this->get_post('username'), $this->get_post('password'));
            }
    ...
    public function register() {
        ...
        if (isset($_POST) and $_POST) {
            ...
            $errors = Membership::instance()->validate_and_register($user, $pass, $rpass);

            if ($errors) {
                $this->set_error($errors['error']);
                $this->clear_pass();
                return;
            }
