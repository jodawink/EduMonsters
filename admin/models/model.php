...
require BASE_DIR . "lib/ClanCats/Hydrahon/Query/Expression.php";
require BASE_DIR . "lib/ClanCats/Hydrahon/Query/Sql/Func.php";
...
class Model {
     ...
     */
    public static function queryBuilder($type = QUERY_BUILDER_ORM) {
    ...
    public static function query($type = QUERY_BUILDER_ORM) {
        return static::queryBuilder($type)->table(static::$table_name);
    }
