 ...
 * BASIC DATA
 */
define('TITLE', 'EduMonsters');
define('DESCRIPTION', 'EduMonsters');
define('KEYWORDS', 'EduMonsters');
...
if (HOST_ID == 0) {
    define('BASE_URL', "https://edumonsters-net.preview-domain.com/");
} else if (HOST_ID == 1) {
    define('BASE_URL', "http://localhost/edumonsters/admin/");
}
...
define('MAIL_BOUNCE', 'trbogazov@gmail.com');
